            ...
            <div class="container mt-4">
                <form class="form">
                    ...
                    <div class="invoice-details">
                        ...
                        <div v-for="(item, index) in invoice_items" :key="index" class="invoice-item">
                            <div class="line"></div>
                            ...
                            <div class="item-type">
                                ...
                                <div class="Type form-label">{{ invoice.type }}</div>
                            </div>
...
.invoice-details .form-control {
    margin-top: -100px;
    /* Ajustați valoarea pentru a muta randurile în sus */
}
