            ...
            <div>
                ...
                <tbody>
                    <tr v-for="customer in customers.data" :key="customer.id || index">
                        ...
                        <td>{{ customer.type }}</td>
                        <td class="row gap-3">
                            <router-link :to="`/customers/show/${customer.id}`" class="p-2 col border btn btn-warning">Show</router-link>
                            <router-link :to="`/customers/edit/${customer.id}`" class="p-2 col border btn btn-info">Edit</router-link>
                            <button @click="confirmDelete(customer.id)" type="button" class="material-iconsp-3 col border btn btn-success">Delete</button>
                        </td>
                    </tr>
                </tbody>
            </table>
